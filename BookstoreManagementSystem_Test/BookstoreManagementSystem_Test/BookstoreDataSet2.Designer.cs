...
namespace BookstoreManagementSystem_Test {
    ...
    public partial class BookstoreDataSet2 : global::System.Data.DataSet {
        ...
        public partial class CustomerDataTable : global::System.Data.TypedTableBase<CustomerRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public CustomerRow AddCustomerRow(int customer_id, string customer_name, int contact_number, string email, string adress) {
...
namespace BookstoreManagementSystem_Test.BookstoreDataSet2TableAdapters {
    ...
    public partial class CustomerTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[Customer] WHERE (([customer_id] = @Original_customer_id) AND (" +
                "[customer_name] = @Original_customer_name) AND ([contact_number] = @Original_con" +
                "tact_number) AND ([email] = @Original_email) AND ([adress] = @Original_adress))";
            ...
            this._adapter.InsertCommand.CommandText = @"INSERT INTO [dbo].[Customer] ([customer_id], [customer_name], [contact_number], [email], [adress]) VALUES (@customer_id, @customer_name, @contact_number, @email, @adress);
SELECT customer_id, customer_name, contact_number, email, adress FROM Customer WHERE (customer_id = @customer_id)";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Customer] SET [customer_id] = @customer_id, [customer_name] = @customer_name, [contact_number] = @contact_number, [email] = @email, [adress] = @adress WHERE (([customer_id] = @Original_customer_id) AND ([customer_name] = @Original_customer_name) AND ([contact_number] = @Original_contact_number) AND ([email] = @Original_email) AND ([adress] = @Original_adress));
SELECT customer_id, customer_name, contact_number, email, adress FROM Customer WHERE (customer_id = @customer_id)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT customer_id, customer_name, contact_number, email, adress FROM dbo.Custome" +
                "r";
        ...
        public virtual int Fill(BookstoreDataSet2.CustomerDataTable dataTable) {
        ...
        public virtual BookstoreDataSet2.CustomerDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            BookstoreDataSet2.CustomerDataTable dataTable = new BookstoreDataSet2.CustomerDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(BookstoreDataSet2.CustomerDataTable dataTable) {
        ...
        public virtual int Delete(int Original_customer_id, string Original_customer_name, int Original_contact_number, string Original_email, string Original_adress) {
        ...
        public virtual int Insert(int customer_id, string customer_name, int contact_number, string email, string adress) {
        ...
        public virtual int Update(int customer_id, string customer_name, int contact_number, string email, string adress, int Original_customer_id, string Original_customer_name, int Original_contact_number, string Original_email, string Original_adress) {
            ...
            this.Adapter.UpdateCommand.Parameters[7].Value = ((int)(Original_contact_number));
            if ((Original_email == null)) {
                throw new global::System.ArgumentNullException("Original_email");
            }
            else {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string customer_name, int contact_number, string email, string adress, int Original_customer_id, string Original_customer_name, int Original_contact_number, string Original_email, string Original_adress) {
            return this.Update(Original_customer_id, customer_name, contact_number, email, adress, Original_customer_id, Original_customer_name, Original_contact_number, Original_email, Original_adress);
        }
    }
