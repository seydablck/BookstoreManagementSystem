...
namespace BookstoreManagementSystem_Test {
    ...
    public partial class BookstoreDataSet1 : global::System.Data.DataSet {
        ...
        public partial class StaffDataTable : global::System.Data.TypedTableBase<StaffRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public StaffRow AddStaffRow(int staff_id, string first_name, string last_name, string job_title, string bank_name, int acc_num) {
        ...
        public partial class StaffRow : global::System.Data.DataRow {
            ...
            public string bank_name {
                get {
                    return ((string)(this[this.tableStaff.bank_nameColumn]));
                }
                set {
                    this[this.tableStaff.bank_nameColumn] = value;
                }
            }
            ...
            public int acc_num {
                get {
                    return ((int)(this[this.tableStaff.acc_numColumn]));
                }
                set {
                    this[this.tableStaff.acc_numColumn] = value;
                }
            }
        }
...
namespace BookstoreManagementSystem_Test.BookstoreDataSet1TableAdapters {
    ...
    public partial class StaffTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = @"DELETE FROM [dbo].[Staff] WHERE (([staff_id] = @Original_staff_id) AND ([first_name] = @Original_first_name) AND ([last_name] = @Original_last_name) AND ([job_title] = @Original_job_title) AND ([bank_name] = @Original_bank_name) AND ([acc_num] = @Original_acc_num))";
            ...
            this._adapter.InsertCommand.CommandText = @"INSERT INTO [dbo].[Staff] ([staff_id], [first_name], [last_name], [job_title], [bank_name], [acc_num]) VALUES (@staff_id, @first_name, @last_name, @job_title, @bank_name, @acc_num);
SELECT staff_id, first_name, last_name, job_title, bank_name, acc_num FROM Staff WHERE (staff_id = @staff_id)";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Staff] SET [staff_id] = @staff_id, [first_name] = @first_name, [last_name] = @last_name, [job_title] = @job_title, [bank_name] = @bank_name, [acc_num] = @acc_num WHERE (([staff_id] = @Original_staff_id) AND ([first_name] = @Original_first_name) AND ([last_name] = @Original_last_name) AND ([job_title] = @Original_job_title) AND ([bank_name] = @Original_bank_name) AND ([acc_num] = @Original_acc_num));
SELECT staff_id, first_name, last_name, job_title, bank_name, acc_num FROM Staff WHERE (staff_id = @staff_id)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT staff_id, first_name, last_name, job_title, bank_name, acc_num FROM dbo.St" +
                "aff";
        ...
        public virtual int Fill(BookstoreDataSet1.StaffDataTable dataTable) {
        ...
        public virtual BookstoreDataSet1.StaffDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            BookstoreDataSet1.StaffDataTable dataTable = new BookstoreDataSet1.StaffDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(BookstoreDataSet1.StaffDataTable dataTable) {
        ...
        public virtual int Delete(int Original_staff_id, string Original_first_name, string Original_last_name, string Original_job_title, string Original_bank_name, int Original_acc_num) {
            ...
            this.Adapter.DeleteCommand.Parameters[5].Value = ((int)(Original_acc_num));
        ...
        public virtual int Insert(int staff_id, string first_name, string last_name, string job_title, string bank_name, int acc_num) {
            ...
            this.Adapter.InsertCommand.Parameters[5].Value = ((int)(acc_num));
        ...
        public virtual int Update(int staff_id, string first_name, string last_name, string job_title, string bank_name, int acc_num, int Original_staff_id, string Original_first_name, string Original_last_name, string Original_job_title, string Original_bank_name, int Original_acc_num) {
            ...
            this.Adapter.UpdateCommand.Parameters[5].Value = ((int)(acc_num));
            ...
            this.Adapter.UpdateCommand.Parameters[11].Value = ((int)(Original_acc_num));
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string first_name, string last_name, string job_title, string bank_name, int acc_num, int Original_staff_id, string Original_first_name, string Original_last_name, string Original_job_title, string Original_bank_name, int Original_acc_num) {
            return this.Update(Original_staff_id, first_name, last_name, job_title, bank_name, acc_num, Original_staff_id, Original_first_name, Original_last_name, Original_job_title, Original_bank_name, Original_acc_num);
        }
    }
